...
module.exports = createCoreController("api::blog-takome.blog-takome", ({ strapi }) => ({
  async findOne(ctx) {
    const { slug } = ctx.params;
    ...
    const post = await strapi.entityService.findMany("api::blog-takome.blog-takome", query);
