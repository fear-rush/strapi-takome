...
// /**
//  * blog-sulamadaha router.
//  */

// const { createCoreRouter } = require('@strapi/strapi').factories;

// module.exports = createCoreRouter('api::blog-sulamadaha.blog-sulamadaha');
...
const { createCoreRouter } = require("@strapi/strapi").factories;
const defaultRouter = createCoreRouter("api::blog-takome.blog-takome");
...
const myOverideRoutes = [
  {
    method: "GET",
    path: "/blog-takomes/:slug",
    handler: "api::blog-takome.blog-takome.findOne",
  },
];
